...
import type { BarberBookingStatus, BarberBookingRange } from "@/app/barber/_actions/bookings";
...
const STATUS_OPTIONS: Array<{ value: BarberBookingStatus; label: string }> = [
  { value: "upcoming", label: "Próximos" },
  { value: "past", label: "Passados" },
  { value: "all", label: "Todos" },
];

const RANGE_OPTIONS: Array<{ value: BarberBookingRange; label: string }> = [
...
const BookingFilters = ({ shopId, status, range }: IProps) => {
  ...
  const setParam = (key: string, value: string | null) => {
    ...
    params.delete("page");
    router.push(`/barber/${shopId}/bookings?${params.toString()}`);
  };
