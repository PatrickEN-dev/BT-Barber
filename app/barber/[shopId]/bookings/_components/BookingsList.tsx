...
import type { listBarberBookings } from "@/app/barber/_actions/bookings";

type Bookings = Awaited<ReturnType<typeof listBarberBookings>>["bookings"];
        ...
        <li key={b.id}>
          <Card>
            <CardContent className="p-3 flex flex-col gap-2">
              ...
              <div className="grid grid-cols-2 gap-2 text-xs border-t border-secondary pt-2">
                <div>
                  <p className="text-[10px] uppercase text-gray-500">Quando</p>
